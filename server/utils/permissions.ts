 ...
 */
export async function hasEditionEditPermission(userId: number, editionId: number): Promise<boolean> {
 ...
 */
export async function hasEditionDeletePermission(userId: number, editionId: number): Promise<boolean> {
