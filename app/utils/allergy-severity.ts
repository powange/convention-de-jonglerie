...
export const ALLERGY_SEVERITY_LEVELS: Record<AllergySeverityLevel, AllergySeverityOption> = {
  LIGHT: {
    value: 'LIGHT',
    label: 'editions.volunteers.allergy_severity_light_short',
    description: 'editions.volunteers.allergy_severity_light_description',
    color: 'neutral',
  ...
  MODERATE: {
    value: 'MODERATE',
    label: 'editions.volunteers.allergy_severity_moderate_short',
    description: 'editions.volunteers.allergy_severity_moderate_description',
    color: 'info',
    icon: 'i-heroicons-exclamation-triangle',
    priority: 2,
  },
  SEVERE: {
    value: 'SEVERE',
    label: 'editions.volunteers.allergy_severity_severe_short',
    description: 'editions.volunteers.allergy_severity_severe_description',
    color: 'warning',
  ...
  CRITICAL: {
    value: 'CRITICAL',
    label: 'editions.volunteers.allergy_severity_critical_short',
    description: 'editions.volunteers.allergy_severity_critical_description',
    color: 'error',
