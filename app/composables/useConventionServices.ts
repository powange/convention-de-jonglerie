...
export const useTranslatedConventionServices = () => {
  ...
  const getTranslatedServices = computed(() => [
    {
      key: 'hasFoodTrucks',
      label: t('services.food_trucks'),
      icon: 'i-mdi:food-outline',
      color: 'text-orange-500',
    },
    {
      key: 'hasKidsZone',
      label: t('services.kids_zone'),
      icon: 'i-heroicons-face-smile',
      color: 'text-pink-500',
    },
    {
      key: 'acceptsPets',
      label: t('services.pets_accepted'),
      icon: 'i-material-symbols:pets',
      color: 'text-amber-600',
    },
    {
      key: 'hasTentCamping',
      label: t('services.tent_camping'),
      icon: 'i-material-symbols:camping-outline',
      color: 'text-green-600',
    },
    {
      key: 'hasTruckCamping',
      label: t('services.truck_camping'),
      icon: 'i-heroicons-truck',
      color: 'text-blue-500',
    },
    {
      key: 'hasFamilyCamping',
      label: t('services.family_camping'),
    ...
    {
      key: 'hasFireSpace',
      label: t('services.fire_space'),
      icon: 'i-heroicons-fire',
      color: 'text-red-600',
    },
    {
      key: 'hasGala',
      label: t('services.gala'),
      icon: 'i-heroicons-sparkles',
      color: 'text-yellow-500',
    },
    {
      key: 'hasOpenStage',
      label: t('services.open_stage'),
      icon: 'i-heroicons-microphone',
      color: 'text-cyan-500',
    },
    {
      key: 'hasLongShow',
      label: t('services.long_show'),
      icon: 'i-heroicons-play-circle',
      color: 'text-purple-600',
    },
    {
      key: 'hasConcert',
      label: t('services.concert'),
      icon: 'i-heroicons-musical-note',
      color: 'text-violet-500',
    },
    {
      key: 'hasCantine',
      label: t('services.canteen'),
      icon: 'i-heroicons-cake',
      color: 'text-amber-500',
    },
    {
      key: 'hasAerialSpace',
      label: t('services.aerial_space'),
      icon: 'i-heroicons-cloud',
      color: 'text-sky-500',
    },
    {
      key: 'hasSlacklineSpace',
      label: t('services.slackline_space'),
      icon: 'i-heroicons-minus',
      color: 'text-teal-500',
    },
    {
      key: 'hasToilets',
      label: t('services.toilets'),
      icon: 'i-guidance:wc',
      color: 'text-gray-600',
    },
    {
      key: 'hasShowers',
      label: t('services.showers'),
      icon: 'i-material-symbols-light:shower-outline',
      color: 'text-blue-400',
    },
    {
      key: 'hasAccessibility',
      label: t('services.accessibility'),
      icon: 'i-bx:handicap',
      color: 'text-blue-600',
    },
    {
      key: 'hasWorkshops',
      label: t('services.workshops'),
