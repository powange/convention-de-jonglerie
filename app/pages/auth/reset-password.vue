  ...
  <div class="flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      ...
      <UCard class="shadow-xl border-0 backdrop-blur-sm bg-white/80 dark:bg-gray-800/80">
        ...
        <UForm
          v-if="!invalidToken && !passwordReset"
          :state="state"
          :schema="schema"
          class="space-y-6"
          @submit="handleSubmit"
        ...
        <div v-if="passwordReset" class="text-center space-y-6">
          ...
          <UButton to="/login" size="lg" block icon="i-heroicons-arrow-right-on-rectangle">
            {{ $t('navigation.login') }}
          </UButton>
        </div>
        ...
        <div v-if="invalidToken" class="text-center space-y-6">
          ...
          <div class="space-y-3">
            <UButton to="/auth/forgot-password" size="lg" block icon="i-heroicons-envelope">
