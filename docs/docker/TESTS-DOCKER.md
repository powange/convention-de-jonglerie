...
npm run app1:docker:test

# Nettoyer après les tests
npm run app1:docker:test:clean
```
...
npm run app1:docker:test:unit

# Nettoyer
npm run app1:docker:test:unit:clean
```
...
npm run app1:docker:test:integration

# Nettoyer
npm run app1:docker:test:integration:clean
```
...
1. Utilisez `npm run app1:docker:test:ui` pour l'interface graphique
