...
export default defineVitestConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: /^#app\/(.*)$/, replacement: resolve(__dirname, 'node_modules/nuxt/dist/app') + '/$1' },
  ...
  { find: /^#app-manifest$/, replacement: resolve(__dirname, 'tests/__mocks__/app-manifest.ts') },
      ...
      { find: '@server-conventions', replacement: resolve(__dirname, 'server/api/conventions/[id]') },
      { find: '@server-carpool-offers', replacement: resolve(__dirname, 'server/api/carpool-offers/[id]') },
      { find: '@server-carpool-requests', replacement: resolve(__dirname, 'server/api/carpool-requests/[id]') },
      ...
      { find: /^(\.\.\/)+__mocks__\/prisma$/, replacement: resolve(__dirname, 'tests/__mocks__/prisma.ts') }
    ]
  },
  test: {
    environment: 'nuxt',
