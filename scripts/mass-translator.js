...
const COMMON_TRANSLATIONS = {
  ...
  "Fermer": {
    en: "Close", es: "Cerrar", de: "Schließen", it: "Chiudi", nl: "Sluiten",
    pl: "Zamknij", pt: "Fechar", ru: "Закрыть", uk: "Закрити", da: "Luk"
  },
...
const CONTEXT_PATTERNS = [
  {
    ...
    translations: {
      en: "Address is required", es: "La dirección es requerida", de: "Adresse ist erforderlich",
      it: "L'indirizzo è richiesto", nl: "Adres is verplicht", pl: "Adres jest wymagany",
      pt: "Endereço é obrigatório", ru: "Адрес обязателен", uk: "Адреса обов'язкова", da: "Adressen er påkrævet"
    }
  },
  {
    pattern: /mot de passe.*requis$/i,
    translations: {
      en: "Password is required", es: "La contraseña es requerida", de: "Passwort ist erforderlich",
      it: "La password è richiesta", nl: "Wachtwoord is verplicht", pl: "Hasło jest wymagane",
      pt: "Senha é obrigatória", ru: "Пароль обязателен", uk: "Пароль обов'язковий", da: "Adgangskode er påkrævet"
    }
  },
  {
    pattern: /chargement/i,
    translations: {
      en: "Loading", es: "Cargando", de: "Laden", it: "Caricamento",
      nl: "Laden", pl: "Ładowanie", pt: "Carregando", ru: "Загрузка", uk: "Завантаження", da: "Indlæser"
    }
  }
];
