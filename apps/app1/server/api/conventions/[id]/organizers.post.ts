...
const addOrganizerschema = z
  .object({
    ...
    perEdition: z
      .array(z.object({ editionId: z.number().int().positive(), ...editionRightsZodShape() }))
      .optional(),
  })
    ...
    return createSuccessResponse({
      organizer: {
        ...
        rights: {
          ...
          manageWorkshops: organizer.canManageWorkshops,
          manageFAQ: organizer.canManageFAQ,
          manageTreasury: organizer.canManageTreasury,
