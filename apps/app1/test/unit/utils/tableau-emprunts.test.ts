...
/**
 * Les deux filtres ajoutés au tableau des prêts : le groupe et l'tag.
 *
 * Même parti que les filtres de lieu et de personne, déjà en place : une LISTE FERMÉE construite
 * sur ce qui est réellement sous les yeux, et non le catalogue de l'édition. Proposer un groupe
 * dont aucun objet n'est emprunté ne viderait pas seulement le tableau — cela ferait douter du
 * filtre lui-même.
 */
/**
 * ⚠️ Les identifiants sont volontairement à CONTRE-SENS des noms.
 *
 * Avec « Cuisine » en 10 et « Scène » en 20, un tri par identifiant aurait rendu le même ordre
